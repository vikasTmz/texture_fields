...
PATH = "C:\\Users\\vikas\\Documents\\Brown_MSCS\\Research\\ShapeTextureRepresntations\\texture_fields\\test_data\\5d59c748-ed7f-4809-ba97-f82f2005961e\\"
...
for num in range(0,10):
    ...
    bpy.ops.render.render()
    os.rename(PATH + 'input_image' + '\\image0001.png ', PATH + 'input_image' + '\\00' + num + '.png')
