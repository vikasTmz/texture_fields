...
for num in range(0,5):
    ...
    bpy.context.scene.node_tree.nodes["File Output.001"].base_path = PATH+'visualize\\image'
    bpy.ops.render.render()
    # os.rename(PATH + 'visualize\\depth' + '\\depth0001.exr ',  PATH + 'visualize\\depth' + '\\00' + num + '.exr')
    os.rename(PATH + 'visualize\\image' + '\\image0001.jpg ', PATH + 'visualize\\image' + '\\00' + num + '.jpg')
